...
ListAduanPage.ɵfac = function ListAduanPage_Factory(t) { return new (t || ListAduanPage)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_router__WEBPACK_IMPORTED_MODULE_1__["Router"])); };
ListAduanPage.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: ListAduanPage, selectors: [["app-list-aduan"]], decls: 30, vars: 0, consts: [["slot", "end"], ["src", "assets/icon/icon-selesai.png"], ["src", "assets/icon/icon-dibaca.png"], ["src", "assets/icon/icon-status-baru.png"], ["type", "submit", "expand", "block", 3, "click"]], template: function ListAduanPage_Template(rf, ctx) { if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function ListAduanPage_Template_ion_button_click_28_listener() { return ctx.back(); });
